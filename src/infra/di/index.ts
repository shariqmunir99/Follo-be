...
} from 'src/app/services/other-services/google-upload.service';

@Module({
  providers: [GoogleDriveUploadService],
  exports: [GoogleDriveUploadService], // Export it if used in other modules
})
...
@Global()
@Module({
  imports: [DbModule, BaseDiModule, GoogleDriveModule],
